...
public class SM2Utils {
     ...
     */
    public static String  sign(String prvKey,String sign) throws NoSuchAlgorithmException, InvalidKeySpecException, SignatureException, InvalidKeyException {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static Boolean verify(String pubKey,String sign,String signResult) throws NoSuchAlgorithmException, SignatureException, InvalidKeySpecException, InvalidKeyException {
    ...
    public static class SignVerify{
        ...
        public SignVerify builder() throws NoSuchAlgorithmException {
            ...
            // 椭圆曲线参数规格
            this.ecParameterSpec = new ECParameterSpec(parameters.getCurve(), parameters.getG(), parameters.getN(), parameters.getH());
            // 获取椭圆曲线KEY生成器
         ...
         * @throws SignatureException
         */
        public String  sign(String prvKey,String sign) throws InvalidKeyException, NoSuchAlgorithmException, SignatureException, InvalidKeySpecException {
         ...
         * @throws SignatureException
         */
        public Boolean verify(String pubKey,String sign,String signResult) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, InvalidKeySpecException {
            byte[] bytes = sign.getBytes();
     ...
     * @return
     */
    public static String sm2Encrypt(String plainText, String pubKey) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidCipherTextException {
        ...
        contentEncrypt = Hex.toHexString(encrypt(bcecPublicKey,plainText.getBytes(StandardCharsets.UTF_8)));
         ...
         *              加密并编码为base64格式
         *             contentEncrypt = Base64.getEncoder().encodeToString(cipher.doFinal(plainText.getBytes()));
         */
     ...
     * @return
     */
    public static String sm2Decrypt(String cipherText, String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidCipherTextException {
        ...
        content = new String( decrypt(bcecPrivateKey,Hex.decode(cipherText)),StandardCharsets.UTF_8);
     ...
     */
    private static byte[] encrypt(SM2Engine.Mode mode, ECPublicKeyParameters pubKeyParameters, byte[] srcData) throws InvalidCipherTextException {
     ...
     */
    /**
     * private static byte[] decrypt(ECPrivateKeyParameters priKeyParameters, byte[] sm2Cipher) throws InvalidCipherTextException {
     *
     *         return decrypt(SM2Engine.Mode.C1C3C2, priKeyParameters, sm2Cipher);
     *     }
     */
    ...
    private static byte[] decrypt(SM2Engine.Mode mode, ECPrivateKeyParameters priKeyParameters, byte[] sm2Cipher) throws InvalidCipherTextException {
        SM2Engine engine = new SM2Engine(mode);
